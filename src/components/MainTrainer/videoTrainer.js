...
export class VideoTrainer extends React.Component {
    render() {
        return (
            <div>
                <MainNavbarTrainer status={{ name: "videoTrainer" }} />
                <div style={{ marginTop: "100px" }}>
                    <div class="col-lg-8 card" style={{ margin: "auto", border: "solid 15px #251EE3", borderRadius: "2%", boxShadow: "1000px" }}>
                        ...
                        <Video autoPlay
                            ...
                            onCanPlayThrough={() => { }}>
                            <source src={this.props.videoFilesTrainerReducer} type="video/webm" />
...
const mapStateToProps = (state) => {
    return {
        videoFilesTrainerReducer: state.videoFilesTrainerReducer,
    }
};


export default connect(mapStateToProps, null)(VideoTrainer)